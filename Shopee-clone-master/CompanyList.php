...
<div class="section-5__selection">                      
    <ul class="section-5__selection-list">
        ...
        ?>
        <li class="section-5__selection-item"><a class="section-5__selection-link" href="index.php?page=1&trang=1?CompanyList&id=<?php echo $row_hang['MAHANG'];?>"><?php echo $row_hang['TENHANG'];?></a></li>
        <?php
        }
        ?>
    </ul>
